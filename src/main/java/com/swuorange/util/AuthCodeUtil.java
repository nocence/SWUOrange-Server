...
/*
 * 
* @Description: 该类用于生4位数的随机验证码
*
* @version: v1.0.0
* @author: Randy
* @date: 2019年2月28日 下午9:40:37
 */
public class AuthCodeUtil {
	...
	/*
	 * @Description: 根据验证码字符串生成图片
	 *
	 * @param authCode 需要转换的随机码
	 * 
	 * @return：返回随机码的图片的BufferedImage
	 * 
	 * @version: v1.0.0
	 * 
	 * @author: Randy
	 * 
	 * @date: 2019年2月28日 下午9:41:58
	 */
