        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                previewSettings: {
                    ...
                    html: {width: "80px", height: "40px"},
                    text: {width: "80px", height: "40px"},
                    office: {width: "80px", height: "40px"},
                    gdocs: {width: "80px", height: "40px"},
                    video: {width: "80px", height: "40px"},
                    audio: {width: "100%", height: "30px"},
                    flash: {width: "80px", height: "40px"},
                    object: {width: "80px", height: "40px"},
                    pdf: {width: "100%", height: "40px"},
                    other: {width: "80px", height: "40px"}
                },
